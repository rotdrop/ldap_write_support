...
class UserBackendRegisteredListener implements IEventListener {
	...
	public function handle(Event $event): void {
		...
		$ldapProvider = $this->container->get('LDAPProvider');
		//$ldapProvider = $this->container->getLDAPProvider();
		//$ldapProvider = $this->container->get(ILDAPProvider::class);
		$ldapUserManager = $this->container->get(LDAPUserManager::class);
		$event->getPluginManager()->register($ldapUserManager);
	}
}
